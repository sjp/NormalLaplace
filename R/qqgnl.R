qqgnl <- function(y, mu = 0, sigma = 1, alpha = 1, beta = 1, rho = 1,
  ...
  x <- qgnl(ppoints(n), param = param)[order(order(y))]
...
ppgnl <- function(y, mu = 0, sigma = 1, alpha = 1, beta = 1, rho = 1,
                 param = c(mu, sigma, alpha, beta, rho),
