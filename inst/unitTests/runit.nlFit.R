...
test.nlFit <- function() {
  ...
  checkTrue(is.numeric(testnlFitDefault$iter) & testnlFitDefault$iter > 0)  # More than one iteration occurred
  ...
  checkTrue(is.numeric(testnlFitBFGS$iter) & testnlFitBFGS$iter > 0)  # More than one iteration occurred
  ...
  checkTrue(is.numeric(testnlFitnlm$iter) & testnlFitnlm$iter > 0)  # More than one iteration occurred
